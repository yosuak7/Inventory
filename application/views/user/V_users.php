              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <?php foreach($list_users as $dd): ?>
                    ...
                    <?php }?>
                    <td><?=$dd->last_login?></td>
                    <td><a type="button"  class="btn btn-info"   href="<?=base_url('user/update_user/'.$dd->id)?>" name="btn_update" style="margin:auto;"><i class="fa fa-pen" aria-hidden="true"></i></a></td>
                    <td><a type="button" class="btn btn-danger btn-delete"  href="<?=base_url('user/proses_delete_user/'.$dd->id)?>" name="btn_delete" style="margin:auto;"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
                </tr>
              <?php endforeach;?>
              <?php }else { ?>
